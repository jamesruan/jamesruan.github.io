...
Ebony is a web page stylesheets collection, based on \link+[ivory]{http://weice.in/ivory/}, designed originally for ZJU's forum \link+[CC98.org]{http://www.cc98.org}(only vaild in ZJU campus).

And This site is based on Ebony. Here is the \link+[DEMO]{ebony}

Ebony is composed of:
\list*{
    \* A responsive grid framework modified from \link+[ivory]{http://weice.in/ivory/};
